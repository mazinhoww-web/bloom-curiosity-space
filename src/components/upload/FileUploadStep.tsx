...
import { ArrowLeft, Upload, Camera, FileText, Image, File, X, AlertCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-muted-foreground">
          {isCamera
            ? "Tire uma foto clara da lista de materiais"
            : "PDF ou imagem da lista de materiais"}
        </p>
      </div>
        ...
        <>
          {isCamera ? (
            <Button
              size="lg"
              variant="outline"
              className="w-full h-32 flex-col gap-3 border-2 border-dashed"
